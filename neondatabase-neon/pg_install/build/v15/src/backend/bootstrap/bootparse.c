...
#line 1 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
...
union YYSTYPE
{
#line 85 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
...
#line 137 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					boot_openrel((yyvsp[0].str));
					do_end();
				}
#line 1356 "bootparse.c"
    break;

  case 15: /* Boot_CloseStmt: XCLOSE boot_ident  */
#line 146 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					closerel((yyvsp[0].str));
					do_end();
				}
#line 1366 "bootparse.c"
    break;

  case 16: /* $@1: %empty  */
#line 155 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					numattr = 0;
...
#line 1380 "bootparse.c"
    break;

  case 17: /* $@2: %empty  */
#line 165 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
					do_end();
				}
#line 1388 "bootparse.c"
    break;
...
#line 169 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
					TupleDesc	tupdesc;
...
#line 1472 "bootparse.c"
    break;

  case 19: /* $@3: %empty  */
#line 252 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					elog(DEBUG4, "inserting row");
					num_columns_read = 0;
				}
#line 1482 "bootparse.c"
    break;

  case 20: /* Boot_InsertStmt: INSERT_TUPLE $@3 LPAREN boot_column_val_list RPAREN  */
#line 258 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
...
#line 271 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
...
#line 323 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
					IndexStmt  *stmt = makeNode(IndexStmt);
					Oid			relationId;
...
#line 1602 "bootparse.c"
    break;

  case 23: /* Boot_DeclareToastStmt: XDECLARE XTOAST oidspec oidspec ON boot_ident  */
#line 375 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
...
#line 1615 "bootparse.c"
    break;

  case 24: /* Boot_BuildIndsStmt: XBUILD INDICES  */
#line 387 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					build_indices();
					do_end();
				}
#line 1625 "bootparse.c"
    break;

  case 25: /* boot_index_params: boot_index_params COMMA boot_index_param  */
#line 396 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.list) = lappend((yyvsp[-2].list), (yyvsp[0].ielem)); }
#line 1631 "bootparse.c"
    break;

  case 26: /* boot_index_params: boot_index_param  */
#line 397 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.list) = list_make1((yyvsp[0].ielem)); }
#line 1637 "bootparse.c"
    break;

  case 27: /* boot_index_param: boot_ident boot_ident  */
#line 402 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
...
#line 1654 "bootparse.c"
    break;

  case 28: /* optbootstrap: XBOOTSTRAP  */
#line 417 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.ival) = 1; }
#line 1660 "bootparse.c"
    break;

  case 29: /* optbootstrap: %empty  */
#line 418 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 0; }
#line 1666 "bootparse.c"
    break;

  case 30: /* optsharedrelation: XSHARED_RELATION  */
#line 422 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 1; }
#line 1672 "bootparse.c"
    break;

  case 31: /* optsharedrelation: %empty  */
#line 423 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.ival) = 0; }
#line 1678 "bootparse.c"
    break;

  case 32: /* optrowtypeoid: XROWTYPE_OID oidspec  */
#line 427 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                { (yyval.oidval) = (yyvsp[0].oidval); }
#line 1684 "bootparse.c"
    break;

  case 33: /* optrowtypeoid: %empty  */
#line 428 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                                        { (yyval.oidval) = InvalidOid; }
#line 1690 "bootparse.c"
    break;

  case 36: /* boot_column_def: boot_ident EQUALS boot_ident boot_column_nullness  */
#line 438 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                {
				   if (++numattr > MAXATTR)
...
#line 446 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = BOOTCOL_NULL_FORCE_NOT_NULL; }
#line 1706 "bootparse.c"
    break;

  case 38: /* boot_column_nullness: XFORCE XNULL  */
#line 447 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                {  (yyval.ival) = BOOTCOL_NULL_FORCE_NULL; }
#line 1712 "bootparse.c"
    break;

  case 39: /* boot_column_nullness: %empty  */
#line 448 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                  { (yyval.ival) = BOOTCOL_NULL_AUTO; }
#line 1718 "bootparse.c"
    break;

  case 40: /* oidspec: boot_ident  */
#line 452 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.oidval) = atooid((yyvsp[0].str)); }
#line 1724 "bootparse.c"
    break;

  case 44: /* boot_column_val: boot_ident  */
#line 463 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                        { InsertOneValue((yyvsp[0].str), num_columns_read++); }
#line 1730 "bootparse.c"
    break;

  case 45: /* boot_column_val: NULLVAL  */
#line 465 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                        { InsertOneNull(num_columns_read++); }
#line 1736 "bootparse.c"
    break;

  case 46: /* boot_ident: ID  */
#line 469 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = (yyvsp[0].str); }
#line 1742 "bootparse.c"
    break;

  case 47: /* boot_ident: OPEN  */
#line 470 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1748 "bootparse.c"
    break;

  case 48: /* boot_ident: XCLOSE  */
#line 471 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1754 "bootparse.c"
    break;

  case 49: /* boot_ident: XCREATE  */
#line 472 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1760 "bootparse.c"
    break;

  case 50: /* boot_ident: INSERT_TUPLE  */
#line 473 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1766 "bootparse.c"
    break;

  case 51: /* boot_ident: XDECLARE  */
#line 474 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1772 "bootparse.c"
    break;

  case 52: /* boot_ident: INDEX  */
#line 475 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1778 "bootparse.c"
    break;

  case 53: /* boot_ident: ON  */
#line 476 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1784 "bootparse.c"
    break;

  case 54: /* boot_ident: USING  */
#line 477 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1790 "bootparse.c"
    break;

  case 55: /* boot_ident: XBUILD  */
#line 478 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1796 "bootparse.c"
    break;

  case 56: /* boot_ident: INDICES  */
#line 479 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1802 "bootparse.c"
    break;

  case 57: /* boot_ident: UNIQUE  */
#line 480 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1808 "bootparse.c"
    break;

  case 58: /* boot_ident: XTOAST  */
#line 481 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1814 "bootparse.c"
    break;

  case 59: /* boot_ident: OBJ_ID  */
#line 482 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1820 "bootparse.c"
    break;

  case 60: /* boot_ident: XBOOTSTRAP  */
#line 483 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1826 "bootparse.c"
    break;

  case 61: /* boot_ident: XSHARED_RELATION  */
#line 484 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1832 "bootparse.c"
    break;

  case 62: /* boot_ident: XROWTYPE_OID  */
#line 485 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1838 "bootparse.c"
    break;

  case 63: /* boot_ident: XFORCE  */
#line 486 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1844 "bootparse.c"
    break;

  case 64: /* boot_ident: XNOT  */
#line 487 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1850 "bootparse.c"
    break;

  case 65: /* boot_ident: XNULL  */
#line 488 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
...
#line 490 "/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//vendor/postgres-v15/src/backend/bootstrap/bootparse.y"
