...
#define CONFIGURE_ARGS " 'CFLAGS=-O2 -g3 ' '--enable-debug' '--with-openssl' 'INSTALL=/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0//scripts/ninstall.sh -C' '--prefix=/home/cloud-user/rpmbuild/BUILD/neondatabase-neon-pg14-1.0.0/pg_install/v14' 'PKG_CONFIG_PATH=:/usr/lib64/pkgconfig:/usr/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 14.6 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 11.2.1 20220127 (Red Hat 11.2.1-9.4.0.2), 64-bit"
